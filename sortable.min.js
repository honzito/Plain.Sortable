...
SortableTable.prototype.getText=function(a){return a.text=a.getAttribute("data-sortval")||a.text||a.textContent||a.innerText||a.innerHTML||""};SortableTable.prototype.getCellText=function(a,b){a.cellTexts=a.cellTexts||[];if(!a.cellTexts[b])try{a.cellTexts[b]=this.getText(a.querySelectorAll("td,th")[b])}catch(d){a.cellTexts[b]="~~~~~~"}return a.cellTexts[b]};
SortableTable.prototype.sortOnColumn=function(a,b){var d=[].slice.call(this.headerRow.cells).indexOf(a);this.headers.forEach(function(a){a.classList.remove("sortup")});this.headers.forEach(function(a){a.classList.remove("sortdown")});var c=this.compareFunction(a.getAttribute("data-sort"));b.order=b.order||1;var f=this;this.rows.sort(function(a,e){return b.order*c(f.getCellText(a,d),f.getCellText(e,d))});b.order*=-1;a.classList.add(1==b.order?"sortup":"sortdown");var e=this.table.tBodies[0];this.rows.forEach(function(a){e.appendChild(a)})};
