...
SortableTable=function(a){var b=this,c=null,e=null;this.table=a;this.rows=[].slice.call(a.tBodies[0].rows);this.headerRow=a.tHead?a.tHead.rows[0]:this.rows.shift();this.headers=this.headerRow.querySelectorAll("th");this.headers.forEach(function(a){var d=document.createElement("div");d.innerHTML=a.innerHTML;d.onclick=function(){b.sortOnColumn(a,d)};a.innerHTML="";a.appendChild(d);a.hasAttribute("data-sortdefault")&&(c=d,e="d"==a.getAttribute("data-sortdefault"))});c&&c.click();e&&c.click()};
...
SortableTable.prototype.sortOnColumn=function(a,b){var c=[].slice.call(this.headerRow.cells).indexOf(a);this.headers.forEach(function(a){a.classList.remove("sortup")});this.headers.forEach(function(a){a.classList.remove("sortdown")});var e=this.compareFunction(a.getAttribute("data-sort"));b.order=b.order||1;var f=this;this.rows.sort(function(a,d){return b.order*e(f.getCellText(a,c),f.getCellText(d,c))});b.order*=-1;a.classList.add(1===b.order?"sortup":"sortdown");var d=this.table.tBodies[0];this.rows.forEach(function(a){d.appendChild(a)})};
